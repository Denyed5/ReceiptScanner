...
namespace ReceiptScanner.Migrations
{
    ...
    [Migration("20260522014421_AddCategories")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReceiptScanner.Areas.Identity.Data.ReceiptScannerUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ReceiptScanner.Models.CategoryModel", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ReceiptScanner.Areas.Identity.Data.ReceiptScannerUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReceiptScanner.Models.RItemModel", b =>
                {
                    b.HasOne("ReceiptScanner.Models.CategoryModel", "Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("ReceiptScanner.Models.ReceiptModel", b =>
                {
                    b.HasOne("ReceiptScanner.Areas.Identity.Data.ReceiptScannerUser", "User")
                        .WithMany("Receipts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
